namespace Samples
{
    partial class Menu
    {
        ...
        private void InitializeComponent()
        {
			...
			this.button1.Text = "Image Upload example";
			...
			this.button2.Text = "Browse Alfresco content";
			...
			this.button3.Text = "Upload a file";
			...
			this.button4.Text = "Mimetype Map Example";
			...
			this.button5.Text = "Browse Data Dictionary";
